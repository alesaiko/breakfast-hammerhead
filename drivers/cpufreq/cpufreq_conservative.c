...
static void cs_check_cpu(struct cs_cpu_dbs_info_s *dbs_info)
{
	...
	u32 up_threshold_burst = cs_tuners.up_threshold_burst, up_threshold;
	u32 max_load = get_policy_max_load(&cs_dbs_data, policy,
		cs_tuners.sampling_rate, cs_tuners.io_is_busy, NULL);
