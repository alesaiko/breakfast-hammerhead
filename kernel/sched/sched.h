...
extern unsigned int __read_mostly sysctl_sched_features;

#define sched_feat_set(x) (sysctl_sched_features |= BIT(x))
#define sched_feat_rem(x) (sysctl_sched_features &= ~BIT(x))
